...
---
In one of our very first product brainstorming, we discussed what will be the [first milestone for Starwards](https://blog.starwards.space/2021-02-13-dogfight-first-milestone/). We agreed that we want to have a fully working dogfight between two ships.
